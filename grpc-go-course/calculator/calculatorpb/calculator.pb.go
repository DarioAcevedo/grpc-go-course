...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x0a, 0x10, 0x43, 0x61, 0x6c, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x19, 0x5a, 0x17,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalulatorService.Sum:input_type -> calculator.SumRequest
	1, // 1: calculator.CalulatorService.Sum:output_type -> calculator.SumResponse
...
// UnimplementedCalulatorServiceServer can be embedded to have forward compatible implementations.
...
func RegisterCalulatorServiceServer(s *grpc.Server, srv CalulatorServiceServer) {
	s.RegisterService(&_CalulatorService_serviceDesc, srv)
}
...
var _CalulatorService_serviceDesc = grpc.ServiceDesc{
